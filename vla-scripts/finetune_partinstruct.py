...
from prismatic.vla.datasets.part_instruct_dataset import find_all_hdf5, load_data_univla
...
class FinetuneConfig:
    ...
    # hdf5 data config                                                             
    camera_names: str = "agentview_rgb"

    # Tracking Parameters
    wandb_project: str = "fientune-part-instruct"                          # Name of W&B project to log to (use default!)
    wandb_entity: str = "twkang43-hanyang-university"                              # Name of entity to log under
